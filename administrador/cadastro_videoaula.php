...
<html lang="pt">
<head>
	<title>Cadastro de Vídeo-Aulas | Papo Jovem!</title>
	<meta charset="UTF-8">
...
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form name = "cadastronoticia" class="login100-form validate-form flex-sb flex-w" enctype="multipart/form-data" method="post" action = "cadastrando_videoaula.php">
				<span class="login100-form-title p-b-51">
						Cadastrar vídeo-aula:
					</span>
