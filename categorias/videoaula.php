...
<html lang="pt-br">
<head>
	<title>Vídeo-Aula | Papo Jovem!</title>
	<meta charset="UTF-8">
...
<body>
				...
				<div class="colunax col1x">
					<nav>
						<ul class="menu inline sem-marcador">
							...
							<li><a class="nav linkAtivo" href="videoaula.php">Vídeo-Aula</a></li>
	...
	<article><br><br><center>
		<?php
			...
			$resultado = mysqli_query($conexao, "SELECT * FROM noticias WHERE categoria=2 ORDER BY id_noticias DESC");
